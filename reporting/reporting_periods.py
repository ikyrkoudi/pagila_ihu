...
table_id = 'reporting_periods_table' # Modify the necessary table name: stg_customer, stg_city etc.
...
with base as (
  select *
  from `capstone-project-495705.reporting_db.reporting_periods_table` --Your table path
  )
