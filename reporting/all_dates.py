...
table_id = 'all_dates' # Modify the necessary table name: stg_customer, stg_city etc.
...
with base as (
  select *
  from `capstone-project-495705.reporting_db.all_dates` --Your table path
  )
...
schema = [
    bigquery.SchemaField('date_column', 'DATE'),
    ]
