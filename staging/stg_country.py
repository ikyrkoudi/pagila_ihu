...
table_id = 'stg_country' # Modify the necessary table name: stg_customer, stg_city etc.
...
with base as (
  select *
  from `capstone-project-495705.pagila_productionpublic.country` --Your table path
  )
